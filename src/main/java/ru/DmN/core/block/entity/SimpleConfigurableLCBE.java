...
public abstract class SimpleConfigurableLCBE<T extends ConfigurableInventory> extends SimpleLCBE<T> implements ConfigurableInventory {
    public SimpleConfigurableLCBE(BlockEntityType<?> blockEntityType, BlockPos blockPos, BlockState blockState, T inventory) {
