...
public class SimpleConfigurableES<T extends SimpleES<T>> extends SimpleES<T> {
    public final Map<Direction, Pair<Boolean, Boolean>> ieTable = new HashMap<>();

    public SimpleConfigurableES(long capacity) {
        super(capacity);
    }

    public SimpleConfigurableES(long energy, long max) {
        super(energy, max);
    }
