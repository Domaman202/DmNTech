 ...
 */
public class SimpleES<T extends SimpleES<T>> implements IESObject <T> {
    public long energy = 0;
    public long capacity;

    public SimpleES(long capacity) {
        this.capacity = capacity;
    }

    public SimpleES(long energy, long max) {
        this(max);
        this.energy = energy;
    }
    ...
    @Override
    public @NotNull SimpleES<T> getEnergyStorage(T obj) {
        return this;
    }
}
