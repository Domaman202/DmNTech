...
public class WrapperConfigurableES<T extends SimpleES<T>> extends WrapperES<T> {
    public final Map<Direction, Pair<Boolean, Boolean>> ieTable;

    public WrapperConfigurableES(IESObject<T> storage) {
        this(storage, new HashMap<>());
    }

    public WrapperConfigurableES(IESObject<T> storage, Map<Direction, Pair<Boolean, Boolean>> ieTable) {
        super(storage);
