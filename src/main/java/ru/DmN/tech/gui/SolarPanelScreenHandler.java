...
public class SolarPanelScreenHandler extends MachineCasingScreenHandler {
    ...
    public SolarPanelScreenHandler(int syncId, PlayerInventory playerInventory, ConfigurableInventory inventory, PropertyDelegate properties, IESObject<?> storage, BlockPos pos) {
