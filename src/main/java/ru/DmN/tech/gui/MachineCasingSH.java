...
public class MachineCasingSH extends MachineScreenHandler {
    ...
    public MachineCasingSH(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, BlockPos pos) {
        super(type, syncId, playerInventory, pos);
        this.addSlot(inventory, 0, 6, 15);
    }

    public MachineCasingSH(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, PropertyDelegate properties, BlockPos pos) {
        super(type, syncId, playerInventory, properties, pos);
        this.addSlot(inventory, 0, 6, 15);
    }

    public MachineCasingSH(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, ConfigurableInventory inventory, PropertyDelegate properties, IESObject<?> storage, BlockPos pos) {
