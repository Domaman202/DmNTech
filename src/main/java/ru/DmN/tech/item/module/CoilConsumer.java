...
public class CoilConsumer extends MachineModule implements ICombinable {
    public static final CoilConsumer INSTANCE = new CoilConsumer();
    ...
    public @NotNull IMaterial getMaterial(ItemStack stack) {
        ItemStack coilStack;
        Item coil;
        if ((coilStack = RMPBBE.tryDecompressCoil(stack)).isEmpty() || !((coil = coilStack.getItem()) instanceof IMaterialProvider))
