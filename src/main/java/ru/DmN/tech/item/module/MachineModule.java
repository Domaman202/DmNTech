...
public abstract class MachineModule extends Module {
    ...
    public boolean updateProperties(@NotNull MachineCasingBE entity, @NotNull ItemStack stack, int slot, MachineCasing.MachineDataType type, Supplier<MachineCasing.IMachineData<?>> data) {
    ...
    public abstract boolean updateProperties(@NotNull MachineCasingBE entity, @NotNull ItemStack stack, int slot);

    public abstract void tick(@NotNull MachineCasingBE entity, @NotNull ItemStack stack, int slot);
