...
import ru.DmN.core.energy.WrapperConfigurableES;
...
public interface MixinSimpleBatteryItem extends IESProvider<ItemStack> {
    ...
    default @NotNull IESObject<ItemStack> getEnergyStorage(@Nullable ItemStack stack) {
        return new WrapperConfigurableES(new TRStorage(EnergyStorage.ITEM.find(stack, new UnknownItemContext(stack)), stack));
    }
}
